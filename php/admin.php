...
<div class="contentbd"> 
    ...
    <section>
        <h1 class="bd__title">Услуги</h1>
                ...
                <div class="tbl-content">
                    ...
                    <tbody>
                        ...
                        <td><?= $price[2] ?></td>
                        <td><?= $price[3] ?></td>
                        <td><a href="vendor/delete2.php?id=<?= $price[0] ?>">Удалить</a></td>
                        <td><a href="adminupdate.php?id=<?= $price[0]?>&name=<?= $price[1]?>&disc=<?= $price[2]?>&cost=<?= $price[3]?>">Изменить</a></td>
                        </tr>
                        <?php
                        }
                        ?>
        ...
        <form action="vendor/addprice.php?id=4" method="post">
            <p>Название</p>
